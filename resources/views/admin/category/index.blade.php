    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="javascript:void(0);" id="addCategory" class="float-right btn btn-outline-success btn-sm"><span class="mdi mdi-plus"></span>&nbsp;Add</a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('admin/category/'.$list->_id.'/edit') }}" class="btn btn-sm btn-outline-info"><span class="mdi mdi-pencil-box-outline"></span></a>
