...
class ShopkeeperController extends Controller
{
    ...
    {
        $user_details = UserDetails::where('userType', 'shopkeeper')->get();
    ...
    public function shopkeeperDetailsEdit(Request $request, $id)
    {
        $data = UserDetails::where('_id', $id)->first();
        return view('admin.shopkeeper.edit', compact('data'));
    }

    public function shopkeeperDetailsSave(Request $request)
    {
        // dd($request->all());
        if ($request->id != '') {
        ...
        if ($request->id != '') {
            ...
            $saveData->save();
            return redirect()->route('shopkeeper-details')->with('success', 'Data updated successfully.');
        } else {
            ...
            $saveData->save();
            return redirect()->route('shopkeeper-details')->with('success', 'Data saved successfully.');
        }
    }

    public function shopkeeperDetailsDelete($id)
    {
